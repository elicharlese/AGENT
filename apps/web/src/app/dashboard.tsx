  ...
  return (
    <Shell title="Dashboard">
      ...
      <div className="relative">
        ...
        <section className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 xl:grid-cols-4 gap-4">
          {[1, 2, 3, 4].map((i) => (
            <div key={i} className="bg-white p-3 md:p-4 radius-8 elev-sm border border-gray-100">
              <div className="text-sm text-gray-500">Metric {i}</div>
              <div className="text-xl md:text-2xl font-semibold mt-1">123</div>
              <div className="text-xs text-gray-500 mt-2">Compared to last week</div>
            </div>
          ))}
        </section>

        <section className="mt-4 md:mt-6 grid grid-cols-1 lg:grid-cols-3 gap-4">
          <div className="bg-white p-3 md:p-4 radius-8 elev-sm border border-gray-100 lg:col-span-2">
          ...
          <div className="bg-white p-3 md:p-4 radius-8 elev-sm border border-gray-100">
            ...
            <div className="flex flex-col gap-2">
              ...
              <a href="/feature-showcase" className="px-3 py-2 text-sm border border-blue-300 bg-blue-50 text-blue-700 radius-8 text-center hover:bg-blue-100">
                Feature Showcase
              </a>
            </div>
          </div>
